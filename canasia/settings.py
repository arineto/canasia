"""
Django settings for canasia project.
...
ROOT_URLCONF = 'canasia.urls'

WSGI_APPLICATION = 'canasia.wsgi.application'
...
#Amazon Settings:
if not DEBUG:
    STATIC_URL = 'http://canasia.s3.amazonaws.com/'
    MEDIA_URL = 'http://canasia.s3.amazonaws.com/'
